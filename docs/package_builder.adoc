...
lutaml-xsd package build urban-schemas.yml \
  --output urban-schemas.zip \
...
[source,shell]
----
lutaml-xsd package build <config-file> --output <output-file> [options]
----
...
[source,shell]
----
lutaml-xsd package build urban-schemas.yml --output urban-schemas.zip
----
...
[source,shell]
----
lutaml-xsd package build config.yml --output output.zip --strict
