...
lutaml-xsd pkg build urban-schemas.yml \
...
[source,shell]
----
lutaml-xsd pkg build <config-file> --output <output-file> [options]
----
...
[source,shell]
----
lutaml-xsd pkg build urban-schemas.yml --output urban-schemas.zip
----
...
[source,shell]
----
lutaml-xsd pkg build config.yml --output output.zip --strict
