...
[source,bash]
----
lutaml-xsd pkg build config.yml --verbose
----
...
[source,bash]
----
lutaml-xsd pkg build config.yml --output schemas.lxr
----
...
----
# Slow (bare mode)
lutaml-xsd pkg build config.yml --resolution-mode bare

# Fast (resolved mode)
lutaml-xsd pkg build config.yml --resolution-mode resolved
----
...
[source,bash]
----
$ lutaml-xsd pkg build --invalid-option
