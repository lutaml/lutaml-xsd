...
Use the [`lutaml-xsd pkg build`](../../reference/CLI#package-build) command with your configuration file:
...
[source,bash]
----
lutaml-xsd pkg build config/my_schemas.yml \
...
The [`lutaml-xsd pkg build`](../../reference/CLI#package-build) command supports these options:
...
lutaml-xsd pkg build config/package.yml \
