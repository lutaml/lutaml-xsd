...
[source,bash]
----
lutaml-xsd pkg build config/iso-dq.yml \
...
----
# ISO 19115 (Metadata)
lutaml-xsd pkg build config/iso-19115.yml \
  --output pkg/iso-19115.lxr

# ISO 19157 (Data Quality)
lutaml-xsd pkg build config/iso-19157.yml \
  --output pkg/iso-19157.lxr

# ISO 19110 (Feature Cataloguing)
lutaml-xsd pkg build config/iso-19110.yml \
