...
module Lutaml
  module Xsd
    ...
    class InteractiveBuilder
      # Public readers for inspection; public writers so test setups and
      # programmatic callers can pre-populate state without bypassing
      # visibility via instance_variable_set.
      attr_accessor :entry_points, :options, :resolved_mappings,
                    :namespace_mappings, :pattern_mappings, :pending_schemas,
                    :processed_schemas, :dependency_count
      attr_reader :prompt
      ...
      # Format file size for display. Pure function promoted to a public
      # class method so callers (and specs) can format sizes without an
      # instance.
      #
      ...
      # Search for schema files matching the location across search_paths.
      ...
      def format_file_size(size)
        self.class.format_file_size(size)
      end
      ...
      def save_configuration
        ...
        File.write(output_path, header_lines.join("\n"))
