...
search_terms = ["Unit", "Quantity", "Dimension", "Prefix", "Symbol"]
...
unit_types = all_types.select { |t| t =~ /(Unit|Quantity|Dimension)/ }.take(5)
...
categories = [:complex_type, :simple_type, :element]
