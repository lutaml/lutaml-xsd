...
schema_mappings = [
  ...
  { from: %r{^\.\./gmd/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gmd/\\1', __dir__
    ) },
  { from: %r{^\.\./gss/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gss/\\1', __dir__
    ) },
  { from: %r{^\.\./gts/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gts/\\1', __dir__
    ) },
  { from: %r{^\.\./gsr/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gsr/\\1', __dir__
    ) },
  { from: %r{^\.\./gco/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gco/\\1', __dir__
    ) },
  { from: %r{^\.\./gmx/(.+\.xsd)$},
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gmx/\\1', __dir__
    ) },
  ...
  { from: /^(basicTypes|coordinateOperations|coordinateReferenceSystems|coordinateSystems|coverage|datums|defaultStyle|deprecatedTypes|dictionary|direction|dynamicFeature|feature|geometryAggregates|geometryBasic0d1d|geometryBasic2d|geometryComplexes|geometryPrimitives|gml|gmlBase|grids|measures|observation|referenceSystems|temporal|temporalReferenceSystems|temporalTopology|topology|units|valueObjects)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/gml/3.2.1/\\1.xsd', __dir__
    ) },
  ...
  { from: /^(applicationSchema|citation|constraints|content|dataQuality|distribution|extent|freeText|gmd|identification|maintenance|metadataApplication|metadataEntity|metadataExtension|portrayalCatalogue|referenceSystem|spatialRepresentation)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gmd/\\1.xsd', __dir__
    ) },

  # GSS files (geometric schema in iso/19139/20070417/gss)
  { from: /^(geometry|gss)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gss/\\1.xsd', __dir__
    ) },

  # GTS files (temporal schema in iso/19139/20070417/gts)
  { from: /^(gts|temporalObjects)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gts/\\1.xsd', __dir__
    ) },

  # GSR files (spatial referencing in iso/19139/20070417/gsr)
  { from: /^(gsr|spatialReferencing)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gsr/\\1.xsd', __dir__
    ) },

  # GCO files (common objects in iso/19139/20070417/gco)
  { from: /^(basicTypes|gco|gcoBase)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gco/\\1.xsd', __dir__
    ) },
  ...
  { from: /^(catalogues|codelistItem|crsItem|extendedTypes|gmx|gmxUsage|uomItem)\.xsd$/,
    to: File.expand_path(
      '../spec/fixtures/codesynthesis-gml-3.2.1/iso/19139/20070417/gmx/\\1.xsd', __dir__
    ) },
