...
ShapeChange integration), see the https://github.com/lutaml/lutaml-klin[lutaml-klin]
gem which orchestrates both https://github.com/lutaml/lutaml[lutaml] (for UML
parsing) and lutaml-xsd (for XSD schema operations).
...
* **Search highlighting**: Highlight search terms in output
