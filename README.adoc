...
====
**Frontend assets:**
- When installing from RubyGems: Assets are pre-built and bundled in the gem
- When developing from git: Run `bundle exec rake build_frontend` first to build the frontend

If you see an error about missing frontend assets, run:
[source,bash]
----
