...
RSpec.describe Lutaml::Xsd::Schema, "helper methods" do
  ...
  let(:parsed_schema) do
    Lutaml::Xsd.parse(schema_content)
  end
  ...
  describe "#valid?" do
    ...
    it "returns false when target namespace is empty" do
      ...
      XSD
      empty_schema = Lutaml::Xsd.parse(empty_schema_content)
  ...
  describe "#summary" do
    ...
    it "handles schema without namespace" do
      ...
      XSD
      no_ns_schema = Lutaml::Xsd.parse(no_ns_schema_content)
