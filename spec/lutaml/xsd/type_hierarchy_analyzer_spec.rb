  ...
  describe "private methods" do
    describe "#extract_base_type" do
      context "with complex content extension" do
        ...
        let(:complex_type) { double("ComplexType", complex_content: complex_content, simple_content: nil, restriction: nil) }
      ...
      context "with simple content extension" do
        ...
        let(:complex_type) { double("ComplexType", complex_content: nil, simple_content: simple_content, restriction: nil) }
