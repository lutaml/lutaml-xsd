  ...
  describe "#validate" do
    ...
    let(:moxml_element) do
      instance_double(
        "Moxml::Element",
        name: "person",
        namespace: instance_double("Namespace", href: "http://example.com",
                                                prefix: "ex"),
      )
    end
    ...
    context "when element name matches" do
      ...
      it "does not report name mismatch error" do
        ...
        name_errors = collector.errors.select do |e|
          e.code == "element_name_mismatch"
        end
    ...
    context "when namespace matches" do
      ...
      it "does not report namespace error" do
        ...
        ns_errors = collector.errors.select do |e|
          e.code == "namespace_mismatch"
        end
